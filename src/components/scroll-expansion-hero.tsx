      ...
      <div ref={containerRef} className="relative w-full h-screen overflow-hidden bg-[#0A0A0A]">
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-center">
          ...
          >
            ...
            <div className={`absolute top-0 left-0 -translate-x-[80%] md:-translate-x-[90%] -translate-y-[20%] md:-translate-y-[30%] z-20 pointer-events-none ${
              textBlend ? 'mix-blend-difference' : 'mix-blend-normal'
            }`}>
              <h2
                ref={leftTextRef}
                className="text-5xl md:text-[6rem] lg:text-[8rem] font-thunder-italic text-[#F5F4F0] leading-[0.8]"
            ...
            <div className={`absolute bottom-0 right-0 translate-x-[80%] md:translate-x-[90%] translate-y-0 md:translate-y-[10%] z-20 pointer-events-none ${
              textBlend ? 'mix-blend-difference' : 'mix-blend-normal'
            }`}>
              <h2
                ref={rightTextRef}
